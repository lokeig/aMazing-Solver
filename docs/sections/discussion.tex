...
Not all algorithms halt when presented with an impossible maze. This could have been fixed in multiple ways but was ignored in order prioritize other functionality.
